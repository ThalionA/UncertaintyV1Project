...
Guidance for Codex (and any AI agent) working in UncertaintyV1Project.
...
- **Keep PNGs previewable: ≤ 2000 px on every side (aim ≤ 1600).** The Codex
...
- **Only ever open / preview PNG inside Codex, never SVG.** To inspect a
